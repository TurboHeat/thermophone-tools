...
if Posx~=1
    ...
    f=figure(7);hold all;plotfunc(N_layers,T(1,:),L0,Posx,cumLo);
    ...
    f=figure(8);hold all;plotfunc(N_layers,q(1,:),L0,Posx,cumLo);
    ...
    f=figure(9);hold all;plotfunc(N_layers,v(1,:),L0,Posx,cumLo);
    ...
    f=figure(10);hold all;plotfunc(N_layers,p(1,:),L0,Posx,cumLo);
    ...
    f=figure(13);hold all;plotfunc(N_layers,T_m(1,:),L0,Posx,cumLo);
