...
Finmat = [ ...
  Mo{inerog}(1, 2), Mo{inerog}(1, 4), -Mob{inerog}(1, 1), -Mob{inerog}(1, 3); ...
  Mo{inerog}(2, 2), Mo{inerog}(2, 4), -Mob{inerog}(2, 1), -Mob{inerog}(2, 3); ...
  Mo{inerog}(3, 2), Mo{inerog}(3, 4), -Mob{inerog}(3, 1), -Mob{inerog}(3, 3); ...
  Mo{inerog}(4, 2), Mo{inerog}(4, 4), -Mob{inerog}(4, 1), -Mob{inerog}(4, 3)];
...
% As a check, BCI and BCI2 should be the same.
for k = 2:Nrounds
  BCI(:, k) = Mo{k} * [0; b1; 0; d1] + SuminvaS{k};
  BCI2(:, f(k)) = Mob{f(k)} * [aN; 0; cN; 0] + SuminvaSb{f(k)};
end
